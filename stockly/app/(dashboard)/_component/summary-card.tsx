...
export const SummaryCardIcon = ({ children }: { children: ReactNode }) => {
  return (
    <div className="mb-2 text-emerald-500 bg-emerald-500 flex h-9 w-9 items-center justify-center rounded-md bg-opacity-10">
      {children}
    </div>
  );
};
...
const SummaryCard = ({ children }: { children: ReactNode }) => {
  return (
    <div className="rounded-xl bg-white p-6 flex flex-col gap-2">
      {children}
    </div>
  )
};
